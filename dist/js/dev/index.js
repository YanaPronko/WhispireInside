...
const initPhoneMask = () => {
  ...
  const applyMask = (code) => {
    ...
    const inputMask2 = new Inputmask$1({ mask, showMaskOnHover: false });
    inputMask2.mask(phoneInput);
    phoneInput.value = "";
...
const ru = { "week": ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"], "month": ["Янв", "Фев", "Мар", "Апр", "Май", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек"], "button": "Применить", "year": "Год (4 цифры)" };
const langs = {
  ua,
  en,
  ru
